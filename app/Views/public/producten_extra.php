                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-3">
                                    <div class="teppetekal-blk woodstone position-relative h-100 p-0">
                                        ...
                                        // ✅ Sold badge logic (outside of string, so no syntax errors)
                                        if (!empty($product['sold']) && $product['sold'] == 1) {
                                            echo '
                                                <div class="sold-triangle">
                                                    <span class="sold-text">Verkocht</span>
                                                </div>
                                            ';
                                        }

                                        echo '
                                        <h3 class="mb-0 fw-bold text-white text-center w-100 position-absolute bottom-0 start-0 z-1">'
                                            . (($bannerTitle == 'Top 10') ? '' : $product['voorraad'] . 'm² op voorraad ' .
                                            ((!empty($product['stuks_pak'])) ? '<br/>' . $product['stuks_pak'] . ' stuks leverbaar' : '')) .
                                        '</h3>
                                    </div>
                                </div>
